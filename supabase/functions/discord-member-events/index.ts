...
Deno.serve(async (request) => {
  ...
  for (const install of installs || []) {
    ...
    if (old.size === 0 && current.size > 0 && route('community_welcome')) {
