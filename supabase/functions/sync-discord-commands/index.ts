...
const commands = [{
  name: 'panel', description: 'Afișează meniul și administrează Panel Pro', options: [
    ...
    { type: 1, name: 'publica', description: 'Publică un embed cu butoane', options: [{ type: 3, name: 'modul', description: 'Embedul de publicat', required: true, choices: [['Anunțuri organizație', 'organization'], ['Anunțuri angajați', 'departments'], ['Pontaj', 'pontaj'], ['Învoiri organizație', 'requests_organization'], ['Învoiri angajați', 'requests_departments'], ['Contracte', 'contracts'], ['Marketplace', 'discovery_marketplace'], ['Marketplace ilegal', 'illegal_marketplace'], ['Evenimente și remindere', 'event_reminders'], ['Raport săptămânal contracte', 'contract_identity_weekly'], ['Status live', 'status_live'], ['Stash', 'stash'], ['Cereri Stash', 'stash_requests'], ['Donații Stash', 'stash_donations']].map(([name, value]) => ({ name, value })) }] },
