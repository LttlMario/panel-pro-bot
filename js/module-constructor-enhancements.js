(() => {
  ...
  fetch('https://zrjxlbkbctlapgupktxw.supabase.co/functions/v1/manage-discord-bot', { method: 'POST', headers: { 'Content-Type': 'application/json', apikey: 'sb_publishable_LfngX7pwFruPw35_ZUdO4Q_MGAHoeW0' }, body: JSON.stringify({ action: 'custom_modules', access_token: token(), application_id: '1531023771211792384' }) }).then(response => response.json()).then(data => {
